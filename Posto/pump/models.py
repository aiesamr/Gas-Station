...
class Abastecimento(models.Model):
    ...
    tipoGas = models.ForeignKey(Bomba, on_delete=models.CASCADE,null=True)
    placa = models.ForeignKey(Veiculo, on_delete=models.CASCADE,null=True)

    def __str__(self):
        return self.datAbastecimento
